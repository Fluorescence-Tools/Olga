...
EvaluatorEulerAngle::makeTask(const FrameDescriptor &frame) const noexcept
{
			       ...
			       const Eigen::Matrix4d &body) const
{
	...
	Eigen::Vector3d angles = (Rrd.transpose() * Rd).eulerAngles(2, 1, 2)
				 * (180.0 / 3.141592653589793);
	if (angles(1) < 0.0) {
		angles = {angles(0) + 180.0, -1.0 * angles(1),
			  angles(2) + 180.0};
